...
# 💡 參照PDF官方簡章：改用 HTML 表格呈現加值課表、修正頭像配置、加入發信安全容錯
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="zh-TW">
<head>
    ...
    <style>
        ...
        button { width: 100%; background: linear-gradient(135deg, #007bff, #0056b3); color: white; border: none; padding: 15px; font-size: 18px; font-weight: bold; border-radius: 6px; cursor: pointer; box-shadow: 0 4px 12 rgba(0,123,255,0.3); transition: all 0.3s; margin-top: 10px; }
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="section-card">
            ...
            <p>您想像過將腦中的藍圖，在 24 小時內轉化為手中真實的觸感嗎？這不僅是一場技術講座課程，更是一場關於「維度跳躍」的實驗。在唯修科技，我們將帶領您突破傳統製造的侷限，從精密零件到客製化藝術品，掌握未來工業的核心競爭力。</p>
            <p>本課程專為對 3D列印技術有實務需求之專業人士及愛好者設計。有鑑於3D列印技術已廣泛應用於醫療、航太、工業設計及個人創作，本公司結合多年設備開發與維修經驗，導入最新的切層邏輯與材料科學實例作為訓練教材。</p>
            ...
            <table class="course-table">
                ...
                <tbody>
                    ...
                    <tr class="value-add-row">
                        <td>⭐ 額外加值課程 (約 10 小時)</td>
                        <td>SOLIDWORKS 軟體認證輔導考證</td>
                    </tr>
                </tbody>
            </table>
            ...
            <ul>
                ...
                <li><strong>課程費用：</strong>每人新台幣 18,000 元（本訓練含考照費用）。請於收到錄取通知後一週內完成繳費。</li>
        ...
        <div class="section-card">
            ...
            <div class="teacher-box">
                ...
                <div class="teacher-info">
                    ...
                    <p>• 專長：FDM/SLA 參數優化、產品結構改良與高精度打樣</p>
                </div>
            </div>
        </div>
    ...
    <div class="footer">
        ...
        <div class="company-meta">
            ...
            🌱 環保叮嚀：現場提供飲水設備，請學員自備環保杯，讓我們為地球盡一份心力。<br>
            💡 課後福利：課後可加入專屬技術交流群組，由專業講師提供為期六個月的線上技術顧問諮詢。
        </div>
...
def submit_registration():
    ...
    # 🛠️ 容錯防禦機制：Render防火牆封鎖外發信件時，改採「背景容錯模式」，絕不卡死前端學員
    try:
        ...
        print("【郵件通知】客服郵件通知已成功發送！")
        
    except Exception as e:
        print(f"⚠️ 【環境防火牆攔截】郵件未成功外發（原因: {str(e)}），但本地報名日誌已安全儲存。")

    return f"""
    <script>
        alert('【唯修科技】您好 {name} 同學，您已成功提交報名資訊！我們將儘速與您聯絡。');
